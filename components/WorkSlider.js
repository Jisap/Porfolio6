                  ...
                  <div key={index} className='relative rounded-lg overflow-hidden flex items-center justify-center group'>
                    <div className='flex items-center justify-center relative overflow-hidden group'>
                      ...
                      opacity-0 group-hover:opacity-80 transition-all duration-700'>
                        {/* title */}
                        <div className='absolute bottom-0 left-0 w-full flex justify-center items-center translate-y-full group-hover:-translate-y-10
                        group-hover:xl:-translate-y-20 transition-all duration-300'>
                          <div className='flex items-center gap-x-2 text-[13px] tracking-[0.2em]'>
                            ...
                            {/* icon */}
                            <div className='text-xl translate-y-[500%] group-hover:translate-y-0 transition-all duratio-300 delay-200'>
                              <BsArrowRight />
                            </div>
                          </div>
                        </div>
